...
signalScore = False
gameStarted = False
sound1=pygame.mixer.Sound('d:/수업/오픈소스/OSS/brian/sounds/s60.ogg')
sound2=pygame.mixer.Sound('d:/수업/오픈소스/OSS/brian/sounds/s62.ogg')
sound3=pygame.mixer.Sound('d:/수업/오픈소스/OSS/brian/sounds/s64.ogg')
sound4=pygame.mixer.Sound('d:/수업/오픈소스/OSS/brian/sounds/s65.ogg')
...
def draw(): # Pygame Zero draw function
    ...
    if gameStarted:
        ...
        if score > 0:
            screen.draw.text("Da Yeong's Final Score : " + str(score), (130, 20), owidth=0.5, ocolor=(255,255,255), color=(255,128,0) , fontsize=60)
        else:
    ...
    if not playingAnimation and gameCountdown == 0:
        screen.draw.text("Now you, Da Yeong!", (225, 20), owidth=0.5, ocolor=(255,255,255), color=(255,128,0) , fontsize=60)
count=0   
number=1
def update(): # Pygame Zero update function
    global myButtons, playingAnimation, playPosition, gameCountdown
    global Sounds, count, number
    if playingAnimation:
      playPosition += 1
...
def on_mouse_down(pos):
    global myButtons, playingAnimation, gameCountdown, playerInput, Sounds
    if not playingAnimation and gameCountdown == 0:
        bcount = 0
        for b in myButtons:
